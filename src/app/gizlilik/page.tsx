        ...
        return (
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col gap-4 pb-4 md:pb-8 md:gap-8">
                <div className='flex flex-col gap-1 md:gap-2'>
                    ...
                    <p className="text-sm md:text-xl"><Link className='text-primary font-bold hover:opacity-80 duration-150' href="/">Sorgulat.com</Link>, kullanıcılara dünya saatleri ve diğer çeşitli hizmetler sunan bir superapp'tir.</p>
                    <ul className="list-inside list-disc text-sm md:text-xl">
                        <li><Link className='text-primary font-bold hover:opacity-80 duration-150' href="/">Sorgulat.com</Link> yalnızca bireysel kullanım için tasarlanmıştır. Otomatik yenileme, metin veya uygulamalar içinden doğrudan erişim yasaktır.</li>
