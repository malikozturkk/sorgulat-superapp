      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col pb-6 md:pb-12 gap-8">
        <div className="w-full aspect-[16/9] bg-[url('/icons/worldMap.svg')] bg-no-repeat bg-center bg-contain flex items-center justify-center">
          <div className="w-full md:w-2/3 flex flex-col gap-4 md:gap-8 items-center">
            ...
            <p className="text-base md:text-lg text-center text-gray-500">Anlık saat bilgilerini görüntüleyin, vize gerekliliklerini haritadan keşfedin ve seyahat rehberlerimizle yolculuğunuza hazırlanın.</p>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="border border-gray-200 rounded-lg p-4 w-full md:w-1/2 flex-1 flex items-stretch justify-between flex-col">
            <div className="w-full">
              <h1 className='text-base md:text-2xl font-extrabold mb-2 md:mb-4'>Saat Kaç?</h1>
              <p className="mb-2 md:mb-4">Dünyanın her yerinde anlık saat bilgisine ulaşın!</p>
          ...
          <div className="border border-gray-200 rounded-lg p-4 w-full md:w-1/2 flex-1 flex items-stretch justify-between flex-col">
            <div className="w-full">
              <h1 className='text-base md:text-2xl font-extrabold mb-2 md:mb-4'>Türkiye Vize Haritası</h1>
              <p className="mb-2 md:mb-4">Türkiye'den vizesiz veya farklı vize türleriyle gidilebilen ülkeleri keşfedin!</p>
        ...
        <div className="border border-gray-200 rounded-lg p-4 w-full flex items-stretch justify-between flex-col">
          <div className="flex justify-between items-start">
            <div>
              <h1 className='text-base md:text-2xl font-extrabold mb-2 md:mb-4'>Seyahat Etmeden Önce Bilmeniz Gerekenler</h1>
              <p className="mb-2 md:mb-4">Ülkelere özel seyahat rehberleri, vize gereklilikleri ve kapsamlı seyahat bilgileriyle yolculuklarınızı planlamanıza yardımcı olacak bloglarımızı keşfedin.</p>
            </div>
